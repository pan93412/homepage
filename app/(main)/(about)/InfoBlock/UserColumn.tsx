  ...
  return (
    <div className="UserColumn flex flex-col gap-2">
      ...
      <Image
        src={panAvatar}
        alt="Pan's Avatar"
        className="UserColumn-avatar block rounded-full"
        width={64}
        height={64}
        priority
      />
      ...
      {/* Name */}
      <h1 className="UserColumn-name text-2xl font-bold text-green-50">
        Yi-Jyun Pan (pan93412)
      </h1>

      {/* Introduction */}
      <p className="UserColumn-intro text-neutral-300">
